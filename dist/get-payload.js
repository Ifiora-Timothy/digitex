                ...
                case 0:
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ email: {
                                ...
                                fromName: "Digitex",
                            }, secret: process.env.PAYLOAD_SECRET, local: (initOptions === null || initOptions === void 0 ? void 0 : initOptions.express) ? false : true }, (initOptions !== null && initOptions !== void 0 ? initOptions : {})));
                    }
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
